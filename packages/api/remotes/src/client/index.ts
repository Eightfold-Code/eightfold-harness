...
import marketplaceRemote from '@deepseek-ai/dsh-marketplace/remote'
...
export type {} from '@deepseek-ai/dsh-marketplace/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentPresetsRemote, commandsRemote, settingsControllerRemote, goalsRemote, llmRemote, marketplaceRemote,
      dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, sessionReferencesRemote,
