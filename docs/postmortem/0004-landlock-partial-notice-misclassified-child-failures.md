...
- The native-boundary regression cases, including informational notices, fatal evidence, and foreground/background classification, are covered by the sandbox e2e suite.
- The assembled product path is pinned by the partial-landlock snapshot composition, independently of filesystem-search implementation choices.
